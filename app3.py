...
if uploaded_file is not None:
    try:
        ...
        st.write("Columns in the uploaded file:", df.columns.tolist())  # Debug output

        if 'Weight' not in df.columns:
            st.error("The uploaded file does not contain a 'Weight' column. Please upload a valid file.")
        else:
